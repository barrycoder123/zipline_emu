...
compile_siloti: siloti_pkg siloti_cnt
	...
	vericom $(VERICOM_OPTIONS) -lib xc_ncwork -sv -f xc_work/v/vericom-xc_ncwork-157-systemverilog.f
	vericom $(VERICOM_OPTIONS) -lib IXCOM_TEMP_LIBRARY -2001 -f xc_work/v/vericom-IXCOM_TEMP_LIBRARY-v2001.f
	vericom $(VERICOM_OPTIONS) -lib IXCOM_TEMP_LIBRARY -sv -f xc_work/v/vericom-IXCOM_TEMP_LIBRARY-1-systemverilog.f
