...
module nx_ram_1r1w_xcm15 ( rst_n, clk, lvm, mlvm, mrdten, bimc_rst_n, bimc_isync, bimc_idat, bimc_odat, bimc_osync, ro_uncorrectable_ecc_error, reb, ra, dout, web, wa, din, bwe );
...
input wire logic [7 : 0] ra ;
output logic [82 : 0] dout ;
input wire logic web ;
input wire logic [7 : 0] wa ;
input wire logic [82 : 0] din ;
input wire logic [82 : 0] bwe ;
endmodule
`end_keywords
