...
module nx_fifo_ctrl_xcm41 ( empty, full, used_slots, free_slots, rptr, wptr, underflow, overflow, clk, rst_n, wen, ren, clear );
parameter DEPTH = 6 ;
...
output wire logic [2 : 0] rptr ;
output wire logic [2 : 0] wptr ;
